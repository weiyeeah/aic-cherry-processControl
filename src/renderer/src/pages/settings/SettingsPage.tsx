...
import MCPFileUploadSettings from './MCPFileUploadSettings'
...
const SettingsPage: FC = () => {
  ...
  return (
    <Container>
      <Navbar>
        <NavbarCenter style={{ borderRight: 'none', marginLeft: '10px' }}>{t('settings.title')}</NavbarCenter>
      ...
      <ContentContainer id="content-container">
        <SettingMenus>
          ...
          <MenuItemLink to="/settings/file-upload">
            <MenuItem className={isRoute('/settings/file-upload')}>
              <Upload size={18} />
              {t('settings.mcpFileUpload.title', '文件上传设置')}
            </MenuItem>
          </MenuItemLink>
        ...
        <SettingContent>
          <Routes>
            ...
            <Route path="file-upload" element={<MCPFileUploadSettings />} />
