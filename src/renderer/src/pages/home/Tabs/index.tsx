...
const HomeTabs: FC<Props> = ({ activeAssistant, activeTopic, setActiveTopic, setActiveAssistant, position, forceToSeeAllTab, style, onCreateAssistant, onCreateDefaultAssistant }) => {
      ...
      {(showTab || (forceToSeeAllTab == true && !showTopics)) && (
        <>
          <Segmented
            ...
            onChange={(value) => setTab(value as 'assistants' | 'topic' | 'settings')}
            block
          />
          <Divider />
        </>
