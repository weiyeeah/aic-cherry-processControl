...
const InputbarTools = ({
  ...
  const getQuickPanelMenuImpl = (params: {
    ...
    const { t, files, model, text, translate } = params
    ...
    return [
      ...
      },
      {
        ...
        action: () => {
          // knowledgeBaseButtonRef.current?.openQuickPanel() // This line was removed
        }
      },
      {
      ...
      },
      {
        ...
        isMenu: true,
        action: () => {
          // webSearchButtonRef.current?.openQuickPanel() // This line was removed
        }
      },
      {
        ...
        isMenu: true,
        action: () => {
          // openSelectFileMenu() // This line was removed
        }
      },
      {
  ...
  useImperativeHandle(ref, () => ({
    ...
    openQuickPanel: () => mentionModelsButtonRef.current?.openQuickPanel()
  }))
  ...
  const visibleTools = useMemo(() => {
    return toolOrder.visible
      ...
      .filter((tool) => tool.key) as ToolButtonConfig[]
